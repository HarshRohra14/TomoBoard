  ...
  return (
    <div className="flex h-full">
      ...
      <motion.div
        ...
        className="w-64 p-4 bg-gray-50 border-r border-gray-200 overflow-y-auto"
      >
        <WhiteboardToolbar
      ...
      <div className="flex-1 relative">
        ...
        <motion.div
          ...
          className="absolute top-4 left-4 z-10 bg-white rounded-lg shadow-md border border-gray-200 px-4 py-2"
        >
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              <Users className="h-4 w-4 text-gray-600" />
              <span className="text-sm text-gray-700">3 collaborators</span>
            </div>
        ...
        <motion.div
          ...
          className="absolute bottom-4 left-4 bg-white rounded-lg shadow-md border border-gray-200 px-4 py-2 max-w-sm"
        >
